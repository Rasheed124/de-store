...
import ProductPriceView from "./products/ProductPriceView";
        ...
        <DialogHeader>
          ...
          <form className="relative" onSubmit={(e) => e.preventDefault()}>
            <Input
              ...
              className="flex-1 rounded-md py-5 font-medium"
              value={search}
            ...
            <button
              type="submit"
              className="absolute right-0 top-0 bg-black/10 w-10 h-full flex items-center justify-center rounded-tr-md hover:bg-black hover:text-white hoverEffect"
            >
              <Search className="w-5 h-5" />
            </button>
          </form>
        </DialogHeader>
        <div className="w-full h-full overflow-y-scroll border border-black rounded-md bg-white">
          <div className="">
            {loading ? (
