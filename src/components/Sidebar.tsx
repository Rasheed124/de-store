...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose, categories }) => {
  ...
  return (
    <div
      className={`fixed inset-y-0 left-0 z-50 w-full bg-black/50 shadow-xl transform ${
    ...
    >
      <motion.div
        ...
        ref={sidebarRef}
        className="min-w-72 max-w-96 bg-black h-full text-primary-foreground p-10 border-r border-r-hoverColor/30 flex flex-col gap-6"
      >
