...
import ImageView from "@/components/products/singleProd/ImageView";
import ProductCharacteristics from "@/components/products/singleProd/ProductCharacteristics";
      ...
      <Container className="flex flex-col md:flex-row gap-10 py-10">
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-5">
          ...
          <div className="flex items-center gap-2.5 lg:gap-5">
            <AddToCartButton
              product={product}
              className="bg-black text-white hover:bg-black hoverEffect"
            />
